...
function TransferMeal(props: TransferMealProp) {
  ...
  if(props.rows){
    for(let i = 0; i<props.rows.length; i++){
        if(equalsIgnoringCase(props.rows[i].email,currUserEmail)){//user
    
            currUserMealSwipes = parseInt(props.rows[i].mealSwipes)
        }
        if(equalsIgnoringCase(props.rows[i].email,inputEmail)){//recipient
  ...
  const UpdateRequest = () => {
    ...
    const body :string =  "{\"tableName\": " + "\"" + "StudentData" + "\"" + ", \"colNameToNewVal\" : {" +  "\"" +"mealSwipes" + "\"" + " : " 
        + "\""+ newNumMealSwipes + "\"" + "}, \"conditions\" : {" 
        + "\"" + "email" + "\"" + " : "  + "\"" + currUserEmail + "\""+ "}}"
    ...
    const recipientBody :string =  "{\"tableName\": " + "\"" + "StudentData" + "\"" + ", \"colNameToNewVal\" : {" +  "\"" +"mealSwipes" + "\"" + " : " 
